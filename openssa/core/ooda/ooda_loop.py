class OODALoop:
    ...
    def __init__(self, objective):
        ...
        self.steps = {
            'Observe': self.Step('Observe', lambda input_data: f"Observe the situation related to the objective '{objective}'"),  # noqa: ARG005
            'Orient': self.Step('Orient', lambda input_data: f"Orient based on the observation: {input_data}"),
            'Decide': self.Step('Decide', lambda input_data: f"Decide the next action based on the orientation: {input_data}"),
            'Act': self.Step('Act', lambda input_data: f"Act based on the decision: {input_data}")
        }
