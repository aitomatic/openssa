"""Agent with Planning, Reasoning, Knowledge & Informational Resources.
...
either dynamic (i.e., with as-needed further decomposition) or static (i.e., as-is).
...
class Agent:
    ...
    # using Observe-Orient-Decide-Act (OODA) by default
    ...
    def add_knowledge(self, *new_knowledge: Knowledge):
        """Add new Knowledge pieces stored in strings."""
