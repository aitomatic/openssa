...
from data_and_knowledge import FbId, Answer, FB_ID_COL_NAME, FILTERED_META_DF, FILTERERED_FB_IDS, FILTERERED_DOC_NAMES_BY_FB_ID, FILTERERED_QS_BY_FB_ID, OUTPUT_FILE_PATH  # noqa: E501
    ...
    def __call__(self, qa_func: QAFunc) -> QAFunc:
        ...
        def decorated_qa_func(fb_id: FbId) -> Answer | None:
            if 'all' in fb_id.lower():
                for _fb_id in tqdm(FILTERERED_FB_IDS):
                    qa_func(_fb_id)
...
class log_qa_and_update_output_file:  # noqa: N801
    ...
    def __call__(self, qa_func: QAFunc) -> QAFunc:
        ...
        def decorated_qa_func(fb_id: FbId) -> Answer:
            logger.info(
                        f'\n{fb_id}\n{FILTERERED_DOC_NAMES_BY_FB_ID[fb_id]}:\n{FILTERERED_QS_BY_FB_ID[fb_id]}\n'
            ...
            if OUTPUT_FILE_PATH.is_file():
                ...
                output_df: DataFrame = FILTERED_META_DF[['doc_name', 'question', 'evidence_text', 'page_number', 'answer']]
